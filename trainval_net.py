...
def parse_args():
    ...
    parser.add_argument('--disp_interval', dest='disp_interval',
                       ...
                       default=50, type=int)#origin:100
    parser.add_argument('--checkpoint_interval', dest='checkpoint_interval',
                       help='number of iterations to display',
                       default=500, type=int)#origin=1000
    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        for step in range(iters_per_epoch):
            ...
            for _ in range(2): # to follow caffe work
                ...
                rois, midn_loss, oc1, oc2, oc3, cls_prob, cam_loss = OICR(im_data, im_rois, labels, num_boxes)
                ...
                print(midn_loss,cam_loss)
                print('TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT')

                loss = midn_loss + oicr_loss + cam_loss
                # //////////////////////////////////////////////////////////////////#
                loss_temp += loss.item()
            ...
            if total_step % args.disp_interval == 0:
                ...
                if step > 0:
                    ...
                    #//////////////////////////
                    loss_cam_temp /= (args.disp_interval + 1)
                    #/////////////////////////
                ...
                #/***************************************************************/
                logger.record_tabular('cam_loss', loss_cam_temp)
                # /***************************************************************/
